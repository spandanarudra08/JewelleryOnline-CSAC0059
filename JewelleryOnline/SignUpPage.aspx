    ...
    <form id="form1" runat="server">
        ...
        <tr>
            ...
            <td class="auto-style3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPassword1" ErrorMessage="Please Enter the same Password"></asp:RequiredFieldValidator>
            </td>
        </tr>
         <tr>
            <td>
        ...
        <tr>
            <td>
                        <asp:TextBox ID="txtCaptcha" placeholder="Type the below Characters" Width="250px" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
